package kz.reself.storage.utils;
...
import kz.reself.storage.config.MinioConfProperties;
...
public class MinioUtil {
    ...
    public MinioUtil(MinioClient minioClient, MinioConfProperties minioProperties) {
